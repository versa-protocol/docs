...
All Versa receivers are registered clients that have been verified during our onboarding process.
Since [sender registration](/customer_registration#receiver-vs-sender-customer-registration) requires explicitly identifying receivers, the Receiver Query API enables you to:
