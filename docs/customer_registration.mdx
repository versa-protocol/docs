...
Below is an example curl request that registers the customer domain `acme.com` to send receipts to the [Sandbox Firehose](https://app.versa.org/sandbox-firehose).
