...
Senders, on the other hand, can only register customers to receive _their_ receipts. E.g. a travel manager admin could opt in to push their American Airlines receipts to their expense management app in their company settings on the American Airlines website, but they would not be able to push their Delta Airlines receipts to their expense management app via the American Airlines website.
