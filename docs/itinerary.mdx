...
The itinerary object is a subset of the [receipt](/receipt) object. It excludes all the financial data from receipts (total, taxes, payment, etc.), and is focused only on travel information (e.g. no e-commerce itemizations).
...
| `vendor_code`          | `nullable string`  | Two-letter GDS vendor code, e.g. `ZI` for Avis, `ZD` for Budget.         |
...
| Field                     | Type               | Description                                                                                                                                                         |
| ------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `service_location`        | `nullable object`  | A [place](/receipts#place) object describing the location where the service was provided (e.g., parking lot, service center).                                       |
