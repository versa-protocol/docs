...
For any given sales receipt, the Versa Registry returns a list of matching authorized receivers. This list of authorized receivers is determined on the basis of a few key transaction details (the domain of the customer’s email, a bank routing number, or a card identifier).
