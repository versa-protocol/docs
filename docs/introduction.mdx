...
Senders then encode the receipt data according to the universal [receipt schema](/receipt), and pass along the encrypted object to the authorized recipients.
