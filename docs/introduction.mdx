...
Create a Versa account at [app.versa.org](https://app.versa.org/). Then senders (merchants) should follow the [Sending](/sending) doc; receivers (expense management apps, financial institutions) should follow the [Receiving](/receiving) doc. Contact us at support@versa.org with questions.
