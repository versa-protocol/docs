...
The Versa Protocol is designed for data transfer without the need to trust a third-party. Senders (merchants) send receipt data directly to customers’ financial services (their bank, their expense management software, etc.).
