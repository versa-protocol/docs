...
If you are a receipt sender (merchant), start wit the [Sending](/sending) doc; if you are a receipt receiver (expense management apps, financial institutions), start with the [Receiving](/receiving) doc. Contact us at support@versa.org with questions.
