...
The Versa Protocol is designed such that merchants send receipts without needing to pass that data through trusted intermediaries. The receipts never touch Versa servers; the exchange is peer-to-peer.
...
Contact us at support@versa.org.
