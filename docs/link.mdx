...
> [!IMPORTANT]
> The only way to support OAuth connections (including QuickBooks and Xero) is via Versa Link. The customer registration API does not support OAuth connections. Versa Link is the best way to ensure future compatibility.
