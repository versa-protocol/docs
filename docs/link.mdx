...
> [!IMPORTANT]
> For the 'inline' and 'dropdown' view modes, you must specify a container element in your HTML with the id `versa-canvas`. The Versa Link script will query for this element by id and render the widget inside. See example below:

```html
<body>
  <div id="versa-canvas" style="padding: 0; margin: 0">
