...
| --------------- | ------- | ------------------------------------------------------------------------------------------------------------ |
| `viewMode`      | `enum`  | One of `modal`, `inline`, or `dropdown`. Defaults to `modal`.                                                |
...
![A comparison of the 'modal' and 'inline' themes.](https://raw.githubusercontent.com/versa-protocol/docs/main/assets/link_viewmode.png "A comparison of the 'modal' and 'inline' themes.")
