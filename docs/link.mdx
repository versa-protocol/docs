...
| ------------- | ------- | ------------------------------------------------------------------------------- |
| `changes`     | `array` | What changed in this Link session. See [change](#change-object) objects.        |
| `connections` | `array` | All currently active connections. See [connection](#connection-object) objects. |
