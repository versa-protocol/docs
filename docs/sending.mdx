...
Youl will then need to adapt your internal receipt data to Versa's [Receipt Schema](/receipt-schema). Configure your merchant name, logo, and brand color on the [Profile](https://app.versa.org/profile) settings screen, and then prototype and preview full receipts in the [Studio](https://app.versa.org/studio).
...
Ready to implement a full 'self-hosted' Versa sender? This configuration involves three steps:
