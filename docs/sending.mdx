...
For test sending, you can use 'sandbox-firehose.versa.org' as the `customer_email_domain` and you can copy one of the sample receipts from the [receipt schema documentation](/receipt). Read the [testing section](#testing-your-connection) for more details.
