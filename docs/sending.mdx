...
Receipt senders are typically merchants or merchant service providers — E-commerce websites, online booking tools, hotel chains, etc. The sender's responsibilities include:
...
Once you’re logged in to your account, you’re able to register your sending client. Go to the 'Client' tab, issue yourself a sender key, and store your credentials somewhere safe.
