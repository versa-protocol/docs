...
The nonce and encrypted Versa receipt are sent to each receiver address, at which point they have the opportunity to check out the key from the registry, and decrypt the envelope.
