...
Typically, receivers indicate which customers they’re authorized to receive receiopts for by [registering their customers](/receiving#customer-registration). However, in certain cases, senders may wish to push their receipts to specific receivers. See [Customer Registration](/customer_registration) for details.
