...
Then, as you make sales, you will check if each of your sales is to a customer who has registered to receive your receipts. If Versa returns a customer match, you will pass the corresponding receipt object along to your customer.

The receipt object itself must conform to Versa's [Receipt Schema](/receipt-schema). You'll adapt your internal purchase data to a Versa receipt. Configure your merchant name, logo, and brand color on the [Profile](https://app.versa.org/profile) settings screen, and then prototype and preview your full, branded receipts in the [Studio](https://app.versa.org/studio).

## Sending Receipts

When you are ready to send receipts, there are two configuration options to pick from:
