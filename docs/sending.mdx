...
This can be done by posting a set of TransactionHandles to the registry checkpoint.
Instead of registering your receipt, send only the customer references, or handles.
This endpoint returns a list of matched receiver profiles instead of their addresses and secrets.
