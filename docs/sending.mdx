...
You'll first need an active sending [client](https://app.versa.org/client). If you already have an active client that you've been using in a custodial configuration, you can continue to use those same keys in a self-hosted configuration.
...
| Field       | Type     | Description                                                   |
| ----------- | -------- | ------------------------------------------------------------- |
| `address`   | `string` | The address where you'll post the encrypted receipt.          |
