...
Ready to implement a full 'self-hosted' Versa sender client? This configuration is similar to the [custodial](#custodial-configuration) approach, but rather than sending your receipts through Versa, the Versa Registry tells you where to send the receipts, and you encrypt and send those receipts directly to the authorized receivers.
