...
Then, as you make sales, you'll check if the buyers are registered to receive your receipts. When Versa returns a positive customer match, you'll send them the receipt object.
