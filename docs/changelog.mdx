...
If you’re a sender, please make a plan to migrate from `1.11.0`. If you’re a Custodial Receiver client, you’ll need to manually update your webhook’s maximum schema version, via the Versa dev portal, to start receiving `2.0.0` data.

### Why?

The `2.0.0` updated incorporates several threads of customer feedback. It enables a richer 'passenger' profile for flights and hotels. And it enables more flexibility around matching and corporate loyalty programs.
