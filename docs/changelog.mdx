...
The `2.0.0` update incorporates several points of customer feedback. It enables a richer 'passenger' profile for flights and hotels. And it enables more flexibility around matching and corporate loyalty programs, to increase match rates.
