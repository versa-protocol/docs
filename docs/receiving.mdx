...
Example payload that you will receive at your registered address.

```json
{
  "receipt_hash": 1234567890,
  "nonce": [12, 124, 123],
  "encrypted": [12, 124, 123]
}
```
...
| -------- | -------- | ------------------------------------------------------------ |
| `key`    | `binary` |                                                              |
| `sender` | `object` | A [merchant object](https://docs.versa.org/receipt#merchant) |
...
Once decrypted, the receiver can either store and render the receipt as they see fit, or they can use the Versa frontend library.
