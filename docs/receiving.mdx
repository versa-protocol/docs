...
The fastest way to get started with a self-hosted receiver client is to use the official Versa [Docker image](https://hub.docker.com/r/versa/client-receiver).
