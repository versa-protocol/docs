...
| `merchant_transaction_id` | `optional string` | No | A stable identifier for the object in your system (e.g. your booking ID). Use this to update or cancel the booking later. |
