...
| `merchant_transaction_id` | `nullable string` | A stable identifier for the object in your system (e.g. your booking ID). Use this to update or cancel the booking later. |
| `transaction_id` | `nullable string` | The parent identifier of a previous event, if updating an existing arrangement. |
