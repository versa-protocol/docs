...
Any asset in the [Receipt schema](/docs/receipts) can be populated with the "asset_id" of the file you uploaded, e.g.

```json
{
  "original_receipt_asset_id": "asset_5ed073abbf3a4b49a8c03191f87d8ffe"
}
```

## Fetch an asset (as a receiver)

Go to 'https://registry.versa.org/asset/asset_5ed073abbf3a4b49a8c03191f87d8ffe' to fetch the asset.
