---
title: "Receipt Schema 2.2.0 Proposal"
---

# Receipt Schema 2.2.0 Proposal

> **Proposal:** This document describes a non-breaking version bump (2.1.0 → 2.2.0) adding four new optional fields to the lodging object, three new optional fields to the car rental object, and `booker` to the customer object in the header.
...
**New in 2.2.0:** `booker` — the person who arranged the purchase (e.g. who booked the flight or hotel, or who bought the items from Amazon).
...
| `booker`   | `nullable object` | **New in 2.2.0.** A [person](#person) object for the person who arranged the purchase (booked, bought). |
...
**New in 2.2.0:** Three optional fields for booking reference and vendor identification: `confirmation_number`, `record_locator`, and `vendor_code`.
...
| `confirmation_number`       | `nullable string`  | **New in 2.2.0.** Rental confirmation number.                                                                                                                   |
| `record_locator`            | `nullable string`  | **New in 2.2.0.** PNR or booking record locator.                                                                                                                |
| `vendor_code`               | `nullable string`  | **New in 2.2.0.** Two-letter GDS vendor code, e.g. `ZI` for Avis, `ZD` for Budget.                                                                              |
...
**New in 2.2.0:** Four optional fields for booking reference, chain identification, and property identifiers: `confirmation_number`, `chain_code`, `property_id`, and `record_locator`.
...
| `confirmation_number`       | `nullable string` | **New in 2.2.0.** Hotel confirmation number.                                                                                                                    |
| `chain_code`                | `nullable string` | **New in 2.2.0.** Two-character chain code, e.g. `mc` for Marriott, `HY` for Hyatt.                                                                             |
| `property_id`               | `nullable string` | **New in 2.2.0.** Property identifier. Examples: `gds.sabre:19835`, `gds.amadeus:BWNYCMQ`, `chain.marriott:NYCMQ`, `giata:17324`.                               |
| `record_locator`            | `nullable string` | **New in 2.2.0.** PNR or booking record locator.                                                                                                                |
