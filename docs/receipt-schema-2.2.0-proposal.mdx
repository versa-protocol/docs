...
> **Proposal:** This document describes a non-breaking version bump (2.1.0 → 2.2.0) adding four new optional fields to the lodging object, and `booker` to the customer object in the header.
