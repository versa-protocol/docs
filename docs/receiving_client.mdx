...
Developer documentation for implementing a self-hosted Versa receiver client, using the [Versa REST API](/receiver). We currently maintain example client implementations for [Rust](https://github.com/versa-protocol/rust-client). Contact us if you'd like assistance with another language.
...
When a sender forwards a receipt to you, they will verify their request with an HMAC verification token using your receiver secret.
...
<TabGroup>
  ...
  <Tab title="NodeJS">
    <CodeWrap title="decrypt.ts" fileUrl="https://github.com/versa-protocol/rust-client/blob/main/src/lib/decrypt.ts">
