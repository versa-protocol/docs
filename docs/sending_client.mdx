...
<TabGroup>
  ...
  <Tab title="Java">
    ...
    // POST transaction handles and receipt metadata to registry
                ...
                for (Receiver receiver : data.receivers) {
                    ...
                    try {
                        ...
                        if (receiverResponse.getStatusCode() == HttpStatus.OK) {
                            ...
                            System.out.println(
                                    "Received error status from receiver: " + receiverResponse.getStatusCode());
                        }
                    } catch (Exception e) {
