...
<TabGroup>
  <Tab title="Rust">
    ...
    ```rust
    let payload = CustomerRegistrationRequest {
        handle: "acme.com".into(),
        handle_type: "customer_email_domain".into(),
        receiver_client_id: Some("versa_cid_prod_5410222b17fa4a4e865e19aebcd77cba".into())
    };
    ...
    let client = reqwest::Client::new();
    let response_result = client
      .post("https://registry.versa.org/handle")
      .header("Accept", "application/json")
      .header("Authorization", credential)
      .header("Content-Type", "application/json")
      .body(payload_json)
