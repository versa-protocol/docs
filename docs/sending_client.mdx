...
<TabGroup>
  ...
  <Tab title="Java">
    <CodeWrap fileName="SendReceiptController.java" fileUrl="https://github.com/versa-protocol/sender-java/blob/main/src/main/java/org/versa/sender/SendReceiptController.java">
      ```java
...
<TabGroup>
  ...
  <Tab title="Java">
    <CodeWrap fileName="HmacUtil.java" fileUrl="https://github.com/versa-protocol/sender-java/blob/main/src/main/java/org/versa/sender/HmacUtil.java">
