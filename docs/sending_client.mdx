...
Developer documentation for implementing a self-hosted Versa sender client, using the [Versa REST API](/sending). We currently maintain example client implementations for Rust and [Java](https://github.com/versa-protocol/sender-java). Contact us if you'd like assistance with another language.
