...
-d '{
    "handles": {
      "customer_email": "john_smith@acme.com"
    },
...
The encryption algorithm used by Versa is AES-GCM-SIV, which is a nonce-misuse resistant authenticated encryption algorithm. You can find implementations in various languages. See [Encryption](encryption) for more information.
