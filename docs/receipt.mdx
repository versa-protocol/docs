...
A JSON Schema docuemnt and corresponding TypeScript Types are available [on GitHub](https://github.com/versa-protocol/schema/blob/main/data/receipt.schema.json) or via the [@versa/schema](https://www.npmjs.com/package/@versa/schema) package.
