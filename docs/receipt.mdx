...
Merchants have the option to provide useful next actions in the Actions section. An action is typically a deep link to a part of ther merchant’s website. For example 'Buy Again' would deep link to a pre-filled shopping cart. Limit of three per receipt.
