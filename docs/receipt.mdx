...
| `departure_timezone`     | `nullable integer` | A list of possible time zone values is maintained at the (IANA Time Zone Database](https://www.iana.org/time-zones). |
| `arrival_timezone`       | `nullable integer` | A list of possible time zone values is maintained at the (IANA Time Zone Database](https://www.iana.org/time-zones). |
