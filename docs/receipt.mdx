...
View a complete [car rental receipt example](https://versa.org/demo/interactive?sender=generic&receipt=car_rental).
...
View a complete [flight receipt example](https://versa.org/demo/interactive?sender=generic&receipt=flight).
...
View a complete [lodging receipt example](https://versa.org/demo/interactive?sender=generic&receipt=lodging).
...
View a complete [transit route receipt example](https://versa.org/demo/interactive?sender=generic&receipt=rideshare).
...
View a complete [subscription receipt example](https://versa.org/demo/interactive?sender=generic&receipt=subscription).
