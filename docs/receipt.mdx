...
| `departure_time`         | `nullable integer` | Departure time. Measured in seconds since the Unix epoch. |
| `arrival_time`           | `nullable integer` | Arrival time. Measured in seconds since the Unix epoch.   |
