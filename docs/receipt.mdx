...
A route, typically used by rideshare / taxi services, or rail / bus. View a complete [taxi receipt](https://versa.org/demo/interactive?sender=generic&receipt=rideshare) example or [rail receipt](https://versa.org/demo/interactive?sender=generic&receipt=rail) example.
