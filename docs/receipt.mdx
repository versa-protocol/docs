...
| Field        | Type              | Description                                                                                   |
| ------------ | ----------------- | --------------------------------------------------------------------------------------------- |
| `type_key`   | `nullable enum`   | One of `sku`, `unspsc`, `asin`. Otherwise leave null and use `custom_key` instead.            |
| `custom_key` | `nullable string` | The type of metadata, e.g. 'Size', 'Brand', 'Product Condition', 'Special Instructions', etc. |
...
| Field    | Type             | Description                                                              |
| -------- | ---------------- | ------------------------------------------------------------------------ |
| `amount` | `int`            | The total tax, in the [smallest currency unit](/definitions#currencies). |
...
| `type`   | `nullable enum`  | One of `amount` or `percentage`.                                       |
| `rate`   | `nullable float` | The discount rate, e.g. 0.1 for 10%. Null for amount-based discount.   |
