...
| `total`             | `integer`         | Total for the line item.                                                                                          |
...
| Field   | Type     | Description                                                                                   |
| ------- | -------- | --------------------------------------------------------------------------------------------- |
| `name`  | `string` | The type of metadata, e.g. 'Size', 'Brand', 'Product Condition', 'Special Instructions', etc. |
| `type`  | `enum`   | One of `sku`, `unspsc`, `asin`, `other`.                                                      |
