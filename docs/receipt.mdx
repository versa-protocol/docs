...
View a complete [car rental receipt](https://versa.org/demo/interactive?sender=generic&receipt=car_rental){:target="\_blank"} example.
...
View a complete [transit route receipt](https://versa.org/demo/interactive?sender=generic&receipt=rideshare) example.
...
View a complete [subscription receipt](https://versa.org/demo/interactive?sender=generic&receipt=subscription) example.
