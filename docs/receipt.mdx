...
> [!TIP]
> The merchant object is used to describe both a sending merchant and a third party merchant. However, in the former case, the merchant object is expanded implicity via the Versa Registry, whereas in the latter case, the merchant object is explicitly encoded into the receipt, via the header `third_party` object.
