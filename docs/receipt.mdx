...
The Itemization section describes the goods and services that compose the purchase. The object conforms to one of seven templates, according to the purchase category: General, Car Rental, E-commerce, Flight, Lodging, Subscription, or Transit Route. Exactly one itemization template must be non-null.
