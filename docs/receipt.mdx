...
A route, typically used by rideshare / taxi services. View a complete [transit route receipt](https://versa.org/demo/interactive?sender=generic&receipt=rideshare) example.
