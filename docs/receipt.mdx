...
| `custom_key` | `nullable string` | The type of metadata, e.g. 'Size', 'Brand', 'Product Condition', etc.              |
...
| Field    | Type     | Description                                                                   |
| -------- | -------- | ----------------------------------------------------------------------------- |
| `amount` | `int`    | The total discount, in the [smallest currency unit](/definitions#currencies). |
