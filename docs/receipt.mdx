...
The Type Block section consists of a series of templates specific to different receipt types. Versa covers the following types: [`car_rental`](#car_rental), [`flight`](#flight), [`location`](#location), [`lodging`](#lodging), [`transit_route`](#transit_route), [`subscription`](#subscription), [`shipment`](#shipment).
...
| Field      | Type     | Description                        |
| ---------- | -------- | ---------------------------------- |
| `location` | `object` | A [place](#place-primitve) object. |
